...
Client side loads the whole page on the initial request and changes the view without refreshing methods while Server-side routing refreshes at every request.
